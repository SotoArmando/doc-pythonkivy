...
class TopNavigationS(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        self.parent_child.add_widget(Label(halign = 'left',valign = 'bottom',text_size = (Window.width - dp(110) - 50,dp(30)),text = "Page Title",font_name = font + "Roboto-Medium.ttf" ,font_size = '20sp'))
        ...
        self.parent.add_widget(self.parent_child)
        self.parent.add_widget(self.search_parent)
    ...
    def bar_animate(self):
        ...
        animate_d = .5
        animate_anim = Animation(rotation = self.Img_parent.rotation+  360, d = animate_d, t = 'in_out_quart')
