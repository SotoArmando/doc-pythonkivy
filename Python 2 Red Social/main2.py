...
class InterfaceManager(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        pantalla3 = Screen(name='Armando3')
        ...
        pantalla3_grid = GridLayout(cols = 1, size_hint = (1,None), height = Window.height+1)
        pantalla3_grid.add_widget(Image(source = hud+"fondo2.png",keep_ratio = False , allow_stretch = True))
        pantalla3_grid.add_widget(Button(background_normal = hud+"fondo2.png",text = "Inntag", size_hint_y = None , height = 70, text_size = (Window.width-50, 35), font_size = 21))
        pantalla3_grid.add_widget(Image(source = hud+"fondo1.png",size_hint_y = None, height = 15,keep_ratio = False , allow_stretch = True))
        ...
        dim8.add_widget(TextInput(padding = [30,17,0,0],background_normal = hud+"fondo1.png", background_active = hud+"fondo1.png", size_hint = (1,None), height = 48, width = 48, text = "Usuario"))
        ...
        dim8.add_widget(TextInput(padding = [30,17,0,0],background_normal = hud+"fondo1.png", background_active = hud+"fondo1.png", size_hint = (1,None), height = 48, width = 48, text = "Contraseña", password = True))
        
        pantalla3_grid.add_widget(dim8)
        pantalla3_grid.add_widget(Image(source = hud+"fondo1.png",keep_ratio = False , allow_stretch = True, size_hint_y = None , height = 35))
        ...
        pantalla3_grid.add_widget(dim10)

        pantalla3_grid.add_widget(Image(source = hud+"fondo1.png",keep_ratio = False , allow_stretch = True, size_hint_y = None , height = 15))
        ...
        Button4 = Button(markup = True,font_size = 17,text = "Demasiado Duro para irse.",text_size =(Window.width-50, 25),size_hint = (None,None), pos = (0,Window.height), size = (Window.width, 50), background_normal = hud + "TT.png", allow_stretch = True , keep_ratio = False)
        self.add_widget(Button4)    
        Inicio = Button(text = NID+"Salir",background_normal = hud+"fondo1.png",markup = True)
        Inicio.bind(on_release = lambda x: self.animar(Button4))
        dim9.add_widget(Inicio)
        
        pantalla3_grid.add_widget(dim9)
        pantalla3_grid.add_widget(Image(source = hud+"fondo2.png",keep_ratio = False , allow_stretch = True))
        pantalla3.add_widget(pantalla3_grid)
        ...
        button4 = Button(markup =True,size_hint_y = None , height = 45, background_normal = hud+"TT4.png",text= NID+"Catàlogos de Comida", text_size =  (Window.width-50,22.5),halign = "left")
        button4.bind(on_release = lambda x : self.cambiar("Catalogos"))
        dim12.add_widget(button4)
    ...
    def animar(self,widget):
        ...
        if widget.pos == [0,Window.height]:
            anim2 = Animation(x=0, y=Window.height,t='in_out_sine', d = .5)
            t2 = Timer(1.5,lambda x=1: anim2.start(widget))
    ...
    def loading(self,button):
        ...
        loadingbar = Popup(pos_hint={'center_x': .5, 'center_y': .5},content = gridload, size_hint = (None,None), size = (100,100), separator_color = [1,1,1,0]   , separator_height = 0 ,title_size = 0, title = "",background =hud+"TT2.png")
        gridload.add_widget(Image(source = hud + "as.gif", size_hint=(None,None), size = (100,100), anim_delay = 0.030))
        loadingbar.open()
        ...
        if num == 1:
            for i in range(6):
                if i == 0:
                    ...
                    tags_strings2 = ["Motherboards","Accessorios","Power Suply","",""]
