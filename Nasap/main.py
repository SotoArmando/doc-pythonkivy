...
from screens.portada import Portada
from screens.shopcart import ShopCart
from screens.menulateral import MenuLateral
...
class InterfaceManager(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        nav.add_widget(MenuL)
        nav.add_widget(Screen_Manager)

        
        Inicio_screen = Inicio()
        Screen_Manager.add_widget(Inicio_screen)
        self.add_widget(nav)
        self.add_widget(TopNavigationS())
