...
class InterfaceManager(RelativeLayout):#COMPLEMENTO 'PARENT' EL PROYECTO
    def __init__(self, **kwargs):
        ...
        self.button1 = Button(background_down = color + "T50.png",size_hint = (None,None), size = (dp(50),dp(50)),on_release = lambda x: self.quit(), background_normal = asset + 'Group 15.png')
        self.button2 = Button(background_down = color + "T50.png",size_hint = (None,None), size = (dp(50),dp(50)),on_release = lambda x: self.pause(), x = Window.width - 50, background_normal = asset + "Group 2.png")
    ...
    def quit(self):
        try:
            ...
            self.pausescreen = GridLayout(pos_hint = {'center_x':.5, 'center_y':.5},cols = 1,size_hint = (None,None), size = (dp(200),dp(300)))
            self.pausescreen.add_widget(Label())
            self.pausescreen.add_widget(Label(size_hint_y = None, height = dp(50), text = "QUIT", font_name = font + "ARCADECLASSIC.ttf", font_size = '28sp'))
            options = GridLayout(cols = 2)
            options.add_widget(Button(font_size = '28sp',background_normal = color + 'None.png',size_hint_y = None, height = dp(50), text = "YES", font_name = font + 'ARCADECLASSIC.ttf'))
            options.add_widget(Button(font_size = '28sp',background_normal = color + 'None.png',size_hint_y = None, height = dp(50),on_release = lambda x: self.pause(), text = "NO", font_name = font + 'ARCADECLASSIC.ttf'))
            self.pausescreen.add_widget(options)
            self.pausescreen.add_widget(Label())
            self.add_widget(self.pausescreen) 
            self.screen1.pause()  
    ...
    def screen2(self):
        ...
        self.musica = Button(size_hint = (None,None), size = (dp(50),dp(50)), background_normal = asset + 'Group 15.png')
