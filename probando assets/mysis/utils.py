...
class CustTextInput(RelativeLayout):
    ...
    def sizing(self):
        ...
        if self.input0.text == "":
            sizing_animate = Animation(font_size = sp(17),text_size = (x[0],dp(75)), d = .255 , t = 'out_cubic')
    ...
    def sizing1(self):
        ...
        sizing_animate = Animation(font_size = sp(13),text_size = (x[0],dp(20)), d = .255 , t = 'out_cubic')
...
class TopNavigationS(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        self.Img = ImageButton(source = asset + "Group 569.png",size_hint = (None,None), size = ('55dp','55dp'))
        ...
        self.parent_child.add_widget(Label(halign = 'left',valign = 'bottom',text_size = (Window.width - dp(110) - 50,dp(30)),markup = True,text = C4+"",font_name = font + "Roboto-Medium.ttf" ,font_size = '20sp'))
