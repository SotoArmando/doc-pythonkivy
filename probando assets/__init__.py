...
from mysis.shopcart import ShopCart,CartItem,SavedItem,ClientButton,StockItem
from mysis.historial import Historial
from mysis.mdata3 import LineMapLayer
from mysis.searcher import Searcher
from mysis.calendario import Calendar
from mysis.autosize import MyButton as SizeButton
from mysis.crear_usuario import CrearUsuario
from mysis.configuracion import Configuracion
from mysis.inicio import Inicio
from mysis.entregas import Entregas,Vendedores
from mysis.clientshow import ClientShow,ClientShow_B
from mysis.recordatorio import Recordatorio,RecordatorioItem
from mysis.utils import GridButton,TwoLineItem,SearchItem,MateriaTitle,TopNavigationS,Datingscreen,BottomNavigation,CustTextInput
import urllib
import datetime
Builder.load_string('''
<NavigationDrawer>:
