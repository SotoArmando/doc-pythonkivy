...
class InterfaceManager(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        pantalla_principall = GridLayout(cols =1)
        ...
        self.env_var1 = Button(size_hint = (None,None), size = (0,0), background_color = [0,0,0,1])
        self.add_widget(self.env_var1)
        button1 = Button(text = "Botones 1")
        button2 = Button(text = "Botones 1")
        button3 = Button(text = "Botones 1")
        button4 = Button(text = "Botones 1")
        button1.bind(on_release = lambda x : self.Custom_Popup(x))
        button2.bind(on_release = lambda x : self.Custom_Popup(x))
        button3.bind(on_release = lambda x : self.Custom_Popup(x))
        button4.bind(on_release = lambda x : self.Custom_Popup(x))
        pantalla_principall.add_widget(button1)
        pantalla_principall.add_widget(button2)
        pantalla_principall.add_widget(button3)
        pantalla_principall.add_widget(button4)
        pantalla_principall.add_widget(Button(text = "Botones 1"))
        pantalla_principall.add_widget(Button(text = "Botones 1"))
    ...
    def Custom_Popup(self,button):
        self.env_var1.pos = (button.pos[0]+100,button.pos[1])
        a = Animation(size = (100,250), d = 1, t = "in_out_back")
        b = Animation(size = (0,0), d = 1, t = "in_out_back")
        c = a + b
        c.start(self.env_var1)
