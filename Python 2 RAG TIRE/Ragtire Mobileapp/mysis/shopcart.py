...
class CartItem(GridLayout):
    def __init__(self,Marca,Descripcion,clasificacion, precio_1, precio_2,precio_3,unidades, **kwargs):
        ...
        texting = C4+self.descripcion+"\n\n[b]Presionar para elegir precio."
        self.CartItem_desc_Descripcion = Button(background_down = color + "16bb.png",halign = 'left',valign = 'top',text_size = (Window.width - dp(184) - dp(25),dp(156)),markup = True,background_normal = color + "16.png",text = texting)
        ...
        self.genial = MyButton(markup = True,background_normal = color + "None.png",text = C4+'   [b]Remover',font_size = '13sp', on_release = lambda x: self.delete_anim(x.parent.parent))
        parienteb.add_widget(self.genial)

        self.bh = MyButton(markup = True,background_normal = color + "None.png",text = C4+'    Guardar   ',font_size = '13sp', on_release = lambda x: self.delete_anim(x.parent.parent))
...
class ShopCart(Screen):
    def __init__(self, **kwargs):
        ...
        scrollview_screen3_root = ScrollView(size_hint_y = None, height = Window.height - dp(79))
        ...
        root_dim_parent = RelativeLayout(size_hint_y = None, height = dp(56))
        ...
        #------------------------------------------------------
        pariente2_root = ScrollView(size_hint_y = None, height = Window.height - dp(0))
        ...
        #self.pariente2.add
        root_dim_parent.add_widget(root_dim1)
 
        root_dim.add_widget(root_dim_parent)
        self.add_widget(root_dim)
        self.add_widget(Image(size_hint_y = None,y = Window.height - dp(79) - dp(56) - dp(35), height = dp(20),source = asset + "Shadow.png",keep_ratio = False, allow_stretch = True))
