...
class CustTextInput(RelativeLayout):
    def __init__(self,i_text,hint_text, **kwargs):
        ...
        left = 49
        pariente.add_widget(Label(font_size = '12sp',text_size = (Window.width-dp(left),dp(20)),valign = 'bottom',size_hint_y = None, height = dp(25),markup = True,text = C1+i_text))
        self.input0 = TextInput(on_text_validate = lambda x: self.on_click_onit(),font_size = '16sp',cursor_color = (0,0,0,1),padding = [dp(-2),dp(5),dp(8),0],multiline = False,size_hint_y = None, height = dp(29),background_normal = color + "None.png",background_active = color + "None.png",markup = True,hint_text = hint_text)
    ...
    def returninput(self): return self.TextInput
...
class TopNavigationS(RelativeLayout):
    def __init__(self, **kwargs):
        ...
        self.TextInput0 =TextInput(hint_text_color = (0,0,0,.91),cursor_color = (0,0,0,.91),foreground_color = [0,0,0,.91],padding = [5,27,0,0],hint_text = "Buscar Tutorias o Materias",font_size = '16sp',background_normal = color + "None.png",background_active = color + "None.png", multiline = False)
