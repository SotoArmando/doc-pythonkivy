...
class Joystick(Widget):
    ...
    inner_size = NumericProperty(0.25)
    pad_size = NumericProperty(.55)
    ...
    outer_background_color = ListProperty([0.75, 0.75, 0.75, 0])
    inner_background_color = ListProperty([0.75, 0, 0, .24])
    pad_background_color = ListProperty([0.4, 0.4, 0.4, .54])
    '''Background colors for the joystick base & pad'''

    outer_line_color = ListProperty([0.25, 0.25, 0.25, 0])
    inner_line_color = ListProperty([0.7, 0.7, 0.7, 0])
    pad_line_color = ListProperty([0.35, 0.35, 0.35, 0])
